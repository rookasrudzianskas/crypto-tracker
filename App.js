      ...
      <View className="flex-1 pt-16 bg-[#121212]">
        <TouchableOpacity className="flex-row items-center justify-between mx-4" activeOpacity={0.7}>
            <View className="flex-row items-center">
                <Image source={{ uri: 'https://assets.coingecko.com/coins/images/1/large/bitcoin.png?1547033579'}} className="w-10 h-10 object-contain" />
                <View className="items-start ml-3 w-[200px]">
                    <Text className="text-white text-xl font-semibold -mb-1">Bitcoin</Text>
                    <View className="flex-row items-center">
                        <View className="w-5 h-5 bg-gray-600 rounded-md items-center justify-center mr-2">
                            <Text className="text-white font-bold">1</Text>
                        </View>
                        <Text className="font-bold uppercase text-gray-400/90 mr-3 tracking-wider">BTC</Text>
