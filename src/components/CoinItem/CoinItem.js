    ...
    return (
        <TouchableOpacity className="flex-row items-center justify-between mx-4 my-2" activeOpacity={0.7}>
            <View className="flex-row items-center">
                ...
                <View className="items-start ml-3 w-[200px] ">
                    ...
                    <View className="flex-row items-center">
                        ...
                        <Text className="font-bold uppercase text-gray-400/90 mr-2 tracking-wider mt-1">{item?.symbol || 'Loading...'}</Text>
                        <View className="flex-row items-center space-x-2 mt-1">
                            ...
                            <Text className="font-bold uppercase text-gray-400/90 tracking-wide">{item.price_change_percentage_24h.toFixed(2) || 0} %</Text>
                        </View>
                    </View>
                </View>
            </View>
            <View>
                ...
                <Text className="text-xl font-bold text-white">{nf.format(item.market_cap) || 0}</Text>
